...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    //  $sql = "INSERT INTO posts (title, body) VALUES ({$title}, {$body})";  SQL Injection
    $sql = "INSERT INTO posts (title, body) VALUES (:title, :body)"; // we use placeholders
    $stmt = $pdo->prepare($sql);
    $params = ['title' => $title, 'body' => $body]; // replace querries
    $stmt->execute($params);
