...
function getAverageSalary($listings)
{
    $salaryArr = array_column($listings, 'salary');
    return array_sum($salaryArr) / count($listings);
}
?>
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-4 mt-4">
        <div class="bg-green-100 rounded-lg shadow-md p-6 my-6">
            <h2 class="text-2xl font-semibold mb-4">Average Salary: <?= formatSalary(getAverageSalary($listings)) ?></h2>
        </div>
        <!-- Output -->
