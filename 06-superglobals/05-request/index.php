...
$description = '';
$submitted = false;
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_REQUEST['submit'])) { // 'submit' is the  name of the field in the form (in this case its button nr.2)
    // var_dump($_POST);

    // we need to filter against attacks: <script>alert("You have been hacked!")</script>
    /*
...
<body class="bg-gray-100">
    <div class="flex justify-center items-center h-screen">
        <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
            ...
            <form method="post"> <!--method needs to be post here -->
                <div class="mb-4">
