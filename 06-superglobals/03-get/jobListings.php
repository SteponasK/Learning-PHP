...
$validLocations = ['Chicago', 'San Francisko', 'New York', 'Seattle', 'Boston'];
...
function filterListingsByLocation($listings, $location)
{
    ...
    // http://php-sandbox.test/index.php/?location=Chicago
}

// Check if location query string is there
// for safety we can have a list of all possible locations, and then compare it to GET 
